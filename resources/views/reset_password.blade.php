    ...
    <div class="login-card">
        ...
        <form action="{{ route('password.update') }}" method="POST">
            ...
            <div class="mb-1">
                ...
                <input type="email" name="email" class="form-control" value="{{ $email }}" readonly style="background: rgba(255,255,255,0.04); color: #9ca3af; border-color: rgba(255,255,255,0.08);">
            </div>
            
            <div class="mb-1">
                <label class="form-label">Password Baru</label>
                <input type="password" name="password" id="password" class="form-control" placeholder="Min. 6 karakter" required autofocus autocomplete="new-password">
            </div>

            <div class="mb-4">
                <label class="form-label">Konfirmasi Password Baru</label>
                <input type="password" name="password_confirmation" id="password-confirm" class="form-control" placeholder="Ulangi password baru" required autocomplete="new-password">
            </div>

            <button type="submit" id="btn-save" class="btn-green">Simpan Password Baru</button>
        </form>

        <a href="/login" class="back-link"><i class="fas fa-arrow-left me-1"></i> Batal</a>
    </div>
